        ...
        {store.species.map((el) => (
          <div key={el.uid} className="col-12 col-md-6 col-lg-3 mb-3">
            <div className="card h-100">
              <Link to={`/details/species/${el.uid}`} className="text-decoration-none">
                <img
                  src={`https://raw.githubusercontent.com/tbone849/star-wars-guide/refs/heads/master/build/assets/img/species/${el.uid}.jpg`}
